...
Step 5. dags/ 폴더 아래에 Test Dag 추가
...
Step 6. 서비스 확인
Q6. Dbeaver를 통해 Postgres DB에 Airflow의 MetaDB가 정상적으로 initialize 되었는지 확인하고, Airflow 웹 UI(localhost:8080)에 접속 가능한지 확인하세요. 추가적으로 test_dag가 잘 보이는지 확인하세요.
